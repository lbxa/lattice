...
When the user wants a personal tool and has not named a repo, ask where it should live rather than assuming a location — do not invent a path under the home directory.
